function Table(type){
	...
	//balls on the table
	let gapR = this.ballRadius+0.1;
	this.balls.push(new Ball(canvas.width/2 + this.il/4, canvas.height/2, this.ballRadius, 0, "white"));
	this.balls.push(new Ball(canvas.width/2 - this.il/4, canvas.height/2, this.ballRadius, 1, RED));
	this.balls.push(new Ball(canvas.width/2 - this.il/4 + gapR*4, canvas.height/2, this.ballRadius, 2, "black"));
	this.balls.push(new Ball(canvas.width/2 - this.il/4 + gapR*8, canvas.height/2, this.ballRadius, 3, YELLOW));
	this.balls.push(new Ball(canvas.width/2 - this.il/4 + gapR*4, canvas.height/2-gapR*2-2, this.ballRadius, 4, YELLOW));
	this.balls.push(new Ball(canvas.width/2 - this.il/4 + gapR*4, canvas.height/2+gapR*2+2, this.ballRadius, 5, YELLOW));
	this.balls.push(new Ball(canvas.width/2 - this.il/4 + gapR*6, canvas.height/2+gapR+2, this.ballRadius, 6, RED));
	this.balls.push(new Ball(canvas.width/2 - this.il/4 + gapR*6, canvas.height/2-gapR-2, this.ballRadius, 7, RED));
	this.balls.push(new Ball(canvas.width/2 - this.il/4 + gapR*2, canvas.height/2-gapR-2, this.ballRadius, 8, RED));
	this.balls.push(new Ball(canvas.width/2 - this.il/4 + gapR*2, canvas.height/2+gapR+2, this.ballRadius, 9, RED));
	this.balls.push(new Ball(canvas.width/2 - this.il/4 + gapR*2, canvas.height/2+gapR*3+3, this.ballRadius, 10, YELLOW));
	this.balls.push(new Ball(canvas.width/2 - this.il/4 + gapR*2, canvas.height/2-gapR*3-3, this.ballRadius, 11, YELLOW));
	this.balls.push(new Ball(canvas.width/2 - this.il/4, canvas.height/2-gapR*2-2, this.ballRadius, 12, YELLOW));
	this.balls.push(new Ball(canvas.width/2 - this.il/4, canvas.height/2+gapR*2+2, this.ballRadius, 13, YELLOW));
	this.balls.push(new Ball(canvas.width/2 - this.il/4, canvas.height/2-gapR*4-4, this.ballRadius, 14, RED));
	this.balls.push(new Ball(canvas.width/2 - this.il/4, canvas.height/2+gapR*4+4, this.ballRadius, 15, RED));
